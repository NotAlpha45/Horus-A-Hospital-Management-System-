...
def get_patient_id(connection, patient_name, patient_phone):
    cursor = connection.cursor()

    query_result = cursor.execute(
        '''SELECT patient_id FROM Patients
        WHERE patient_name = :p_name AND patient_phone_number = TO_NUMBER(:p_number)
        ''',
...
#     patient_phone_number='01098654757',
